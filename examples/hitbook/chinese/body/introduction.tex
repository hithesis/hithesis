...
\begin{figure}[htpb]
	...
	\begin{minipage}{\linewidth}
		...
		\begin{minipage}{\textwidth}
			\centering
			\subfigure{\label{fig:com_tracking}}\addtocounter{subfigure}{-2}
			\subfigure[The person playing golf]{\subfigure[无负载时]{\includegraphics[width=0.4\textwidth]{tracking}}}
%			\hspace{4em}
			\subfigure{\label{fig:com_tracking_withweight}}\addtocounter{subfigure}{-2}
			\subfigure[The person playing golf]{\subfigure[有负载时]{\includegraphics[width=0.4\textwidth]{tracking}}}
		\end{minipage}
		\vskip 0.2em
%		\wuhao 注意：这里是中文图注添加位置（我工要求，图注在图题之上）。
		\vspace{0.2em}
		\bicaption[golfer47]{}{负载变化情况下的质心跟踪误差}{Fig.$\!$}{Simulation results of CoM 
			tracking}
	\end{minipage}
\end{figure}
...
\begin{table}[htbp]
\bicaption[table1]{}{符合研究生院绘图规范的表格}{Table$\!$}{Table in agreement of the standard from graduate schoolTable in agreement of the standard from graduate school}
...
\longbionenumcaption{}{{\wuhao 中国省级行政单位一览}\label{table2}}{Table$\!$}{}{{\wuhao Overview of the provincial administrative unit of ChinaOverview of the provincial administrative unit of China}}{-0.5em}{3.15bp}\\
