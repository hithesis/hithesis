...
本课题来源于中广核基础研究合作支持项目。风这一自然现象具有波动大，不稳定等特点，对于风功率的预测，对风电企业的盈利，电价的制定，
超短期风功率预测是风功率预测的一个重要指标，超短期预测是每个整点起报，预测4H内的风功率，时间粒度为10分钟或15分钟一个点。
传统的基于单源数据的方法，对于超短期的风功率的预测均没有好的效果，
