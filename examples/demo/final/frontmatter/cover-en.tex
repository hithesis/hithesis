...
% 封面上「（学术学位论文）」那一行。不写就由文档类选项 degree-type 给：
% academic 出「学术学位论文」，professional 出「专业学位论文」。要写别的
% （同等学力人员、工程硕士、工商管理硕士……）就在这里覆盖。
% 它是固定词汇不是元信息，所以在 const 族里。
\hitsetup{
  const = {
    zh = { degree-type={同等学力人员} }, %非全日制教育申请学位者
    en = { degree-type={Master of Art} },
  },
}
