...
To facilitate IC testing, \gls{etssbp} design-for-testability (DFT) technique was proposed to add some specific design structure to improve the testability of CUT\cite{hithesis2017,cnarticle}. 
